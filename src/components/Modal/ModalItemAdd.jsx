      ...
      <div className="relative w-full max-w-[720px] flex flex-col bg-white rounded-2xl shadow-2xl max-h-[90vh]">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 custom-scrollbar">
          ...
          <div className="mt-6 flex flex-col gap-4">
            ...
            {items?.success === false && (
              <p className="text-center">No se han podido cargar productos.</p>
            )}
            {Array.isArray(items) && availableItems.length === 0 && (
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      {item.supermarket && item.supermarket !== "CUALQUIERA" && (
                        <PillGenerical
                          category={SUPERMARKET_LABELS[item.supermarket] || item.supermarket}
                        />
                      )}
                      {item.categories?.map((category) => (
                        <PillGenerical key={category} category={category} />
                      ))}
                    </div>
                  </div>
